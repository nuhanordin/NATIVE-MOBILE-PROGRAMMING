...
class ForageableViewModel(private val forageableDao: ForageableDao): ViewModel() {
 ...
 val getAll: LiveData<List<Forageable>> = forageableDao.getForageables().asLiveData()
    ...
    //  database by id via the DAO.
     ...
     fun getforagable(id: Long): LiveData<Forageable> = forageableDao.getForageable(id).asLiveData()
